...
- Migrated from using nodemon and express server to vite dev server via the `[https://www.npmjs.com/package/vite-plugin-node](https://www.npmjs.com/package/vite-plugin-node)` plugin.
